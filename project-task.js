...
*/
let upperCaseProductNameArray = products.map((product) => (product.name.toUpperCase()));
...
*/
const totalPrice = products.reduce((total, product) => product.inStock ? total + product.price : total, 0);

// ============================================
// 🧪 Console Test Your Work
// ============================================

console.log("Filtered products:", filterProducts(products, product => product.price > 750));
console.log("Uppercased names:", upperCaseProductNameArray);
